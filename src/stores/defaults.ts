...
export const conversations = [
  ...
  },
  {
    ...
    messages: [
      {
        id: 1,
        content: 'A truck collision turns a Florida highway into a silver sea of beer cans',
        date: '1:00 pm',
        state: 'read',
        sender: {
          id: 1,
      ...
      {
        id: 2,
        content: 'Apple Watch Ultra and next-generation AirPods Pro available in stores Friday',
        date: '5:00 pm',
        state: 'read',
        sender: {
          id: 1,

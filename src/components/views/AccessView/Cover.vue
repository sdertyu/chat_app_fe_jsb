...
import cloudPatternPath from "@/assets/images/clouds.png";
import blurPath from "@/assets/images/blur.png";
</script>

<template>
    <div class="py-12.5 px-12.5 h-full basis-1/2 md:flex xs:hidden items-center justify-center">
        <div class="w-full h-full px-7 flex items-center bg-no-repeat bg-center bg-cover rounded-[.75rem]"
            ...
            <div class="px-9 py-15 rounded-[.3125rem] bg-cover bg-no-repeat"

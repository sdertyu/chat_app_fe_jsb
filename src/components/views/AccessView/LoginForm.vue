...
<template>
    <div class="p-5 md:basis-1/2 xs:basis-full flex flex-col justify-center items-center">
        <div class="w-full md:px-[26%] xs:px-[10%]">
            ...
            <!--form-->
            <div class="mb-6">
                <LabeledTextInput label="Email" placeholder="Enter your email" class="mb-5" />
            ...
            <!--local controls-->
            <div class="mb-6">
                <Button class="contained-primary contained-text w-full mb-4" link to="/chat/no-chat/">Sign in</Button>
            </div>

            <!--divider-->
            <div class="mb-6 flex items-center">
                <span
                    class="w-full border border-dashed border-gray-100 dark:border-gray-600 rounded-[.0625rem]"></span>
            ...
            <div>
                <Button class="outlined-primary outlined-text w-full mb-5">
                    <img src="@/assets/vectors/google-logo.svg" class="mr-3" alt="google logo" />
                    Sign in with google
                </Button>

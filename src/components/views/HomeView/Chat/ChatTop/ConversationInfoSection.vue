...
import { activeCall } from "@/stores/defaults";
    ...
    <div class="w-full flex justify-center items-center">
        ...
        <div v-if="store.status !== 'loading'" class="flex grow">
            ...
            <div class="flex flex-col">
                <p class="w-fit heading-2 text-black/70 dark:text-white/70 mb-2 cursor-pointer"
                    @click="props.handleOpenInfo" tabindex="0">
        ...
        <div class="flex" :class="{ hidden: store.status === 'loading' }">
            ...
            <div class="relative">
                ...
                <IconButton id="open-conversation-menu" class="ic-btn-ghost-primary open-top-menu group w-7 h-7"
                    ...
                    aria-controls="conversation-menu" title="toggle conversation menu"
                ...
                <Dropdown id="conversation-menu" :close-dropdown="() => (showDropdown = false)" :show="showDropdown"
                    ...
                    <button class="dropdown-link dropdown-link-primary" aria-label="Show profile information"
                        role="menuitem" @click="
                            () => {
                                handleCloseDropdown();
                    ...
                    <button class="dropdown-link dropdown-link-primary"
                        aria-label="start a voice call with this contact" role="menuitem" @click="
                            () => {
                                handleCloseDropdown();

...
import AccountDropdown from "@/components/views/HomeView/Navigation/AccountDropdown.vue";
import Logo from "@/components/views/HomeView/Navigation/Logo.vue";
import NavLink from "@/components/views/HomeView/Navigation/NavLink.vue";
        ...
        <div class="grow">
            <nav aria-label="Main navigation">
                <ul class="xs:flex md:block xs:justify-between xs:items-center">
                    ...
                    <li>
                        <AccountDropdown id="small-profile-menu" class="xs:block md:hidden"
                            aria-labelledby="small-profile-menu-button" :show-dropdown="showDropdown"
        ...
        <div>
            <nav aria-label="Extra navigation" class="xs:hidden md:block">
                <ul>
                    ...
                    <li>
                        <NavLink :icon="store.settings.darkMode ? SunIcon : MoonIcon" title="Night mode"
            ...
            <AccountDropdown id="profile-menu" class="xs:hidden md:block" aria-labelledby="profile-menu-button"
                :show-dropdown="showDropdown" :handle-show-dropdown="() => (showDropdown = true)"
                :handle-close-dropdown="() => (showDropdown = false)" />
        </div>
    </div>
</template>

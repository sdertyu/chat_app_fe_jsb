...
<template>
    <div class="relative">
        ...
        <button :id="props.id + '-button'" @click="handleShowDropdown"
        ...
        <!--dropdown menu-->
        <Dropdown :id="props.id + '-dropdown'" :aria-labelledby="props.id + '-button'" :show="props.showDropdown"
            :position="[
                'md:bottom-0',
                'md:left-8',
                'md:top-auto',
            ...
            <RouterLink to="/reset/" class="dropdown-link dropdown-link-primary" aria-label="change password"
                role="menuitem" @click="props.handleCloseDropdown">
                <ArrowPathIcon class="h-5 w-5 mr-3 text-black opacity-60 dark:text-white dark:opacity-70" />
                Password Change
            </RouterLink>

            <RouterLink to="/access/sign-in/" class="dropdown-link dropdown-link-danger" aria-label="logout"
                role="menuitem" @click.prevent="props.handleCloseDropdown">

        ...
        <template v-slot:content>
            <div class="w-75 py-6 bg-white dark:bg-gray-800 rounded">
                ...
                <ScrollBox ref="contactContainer" class="max-h-54 mb-5 overflow-y-scroll">
                    ...
                    <ContactItem v-else-if="store.user" v-for="(contact, index) in store.user.contacts"
                        :contact="contact" @click="handleSelectedContactsChange(contact)"
                        :active="isContactSelected(contact)" :key="index">

...
import CallInfoTab from "@/components/shared/modals/CallInfoModal/CallInfoTab.vue";
import CallMembersTab from "@/components/shared/modals/CallInfoModal/CallMembersTab.vue";

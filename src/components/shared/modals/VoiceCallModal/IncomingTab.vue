...
import type { ICall, IContact } from "@/types";

import { getCallName } from "@/utils";

import { PhoneIcon, XMarkIcon } from "@heroicons/vue/24/solid";
import CallAvatar from "@/components/shared/blocks/CallAvatar.vue";
...
<template>
    <div class="w-full h-full py-6 flex flex-col items-center">
        ...
        <!--answer button-->
        <div class="flex">
            <IconButton @click="handleCallStatusChange('ongoing')"
                class="ic-btn-contained-success relative p-4.25 mr-8">
                <PhoneIcon class="w-5 h-5" />
                <span
                    class="animate-ping absolute inline-flex w-8.75 h-8.75 rounded-full bg-green-400 opacity-75"></span>
            </IconButton>
